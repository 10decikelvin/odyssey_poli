...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{controller_8cpp_a4fc01d736fe50cf5b977f755b675f11d}{setup}} ()
\begin{DoxyCompactList}\small\item\em Main setup function. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{controller_8cpp_afe461d27b9c48d5921c00d521181f12f}{loop}} ()
...
void \mbox{\hyperlink{controller_8cpp_ab0787836dbac9ac3282c7a75e2fa610e}{send\+Encoder}} ()
...
\begin{DoxyCompactItemize}
\item 
const int \mbox{\hyperlink{controller_8cpp_a1cae64bb9fe4e2c5b2c428375c53efd1}{Motor\+RLEN}} = 6
\item 
const int \mbox{\hyperlink{controller_8cpp_ac785618ca1a33df4380be9a615d5f174}{Motor\+RREN}} = 7
\item 
const int \mbox{\hyperlink{controller_8cpp_a09e09e0862b9750ad5f4e9634766ffab}{Motor\+RLPWM}} = 8
\item 
const int \mbox{\hyperlink{controller_8cpp_a9146477edd755d01a99fe34e05f90ec8}{Motor\+RRPWM}} = 9
\item 
const int \mbox{\hyperlink{controller_8cpp_a4e06646df6da7b312a077883a53d1e60}{Motor\+LLEN}} = 10
\item 
const int \mbox{\hyperlink{controller_8cpp_ae0ffb79f982352ded2ee139f7b048979}{Motor\+LREN}} = 11
\item 
const int \mbox{\hyperlink{controller_8cpp_a1b7a47d17609652e25722b2bde57764c}{Motor\+LLPWM}} = 12
\item 
const int \mbox{\hyperlink{controller_8cpp_ab0acde7949aaec1b50231ecd5e7007cc}{Motor\+LRPWM}} = 13
\item 
const int \mbox{\hyperlink{controller_8cpp_a0fed02acc4ae19ecb7c031c63daa7534}{encoder\+RPinA}} = 2
\item 
const int \mbox{\hyperlink{controller_8cpp_af0a6d6ca24cf529c231f004d433cd150}{encoder\+RPinB}} = 4
\item 
const int \mbox{\hyperlink{controller_8cpp_a9fbbd7dc890701e0443abc1a21ac0006}{encoder\+LPinA}} = 3
\item 
const int \mbox{\hyperlink{controller_8cpp_a567fe466db6b232554d452b32157562c}{encoder\+LPinB}} = 5
\item 
...
\Hypertarget{controller_8cpp_afe461d27b9c48d5921c00d521181f12f}\index{controller.cpp@{controller.cpp}!loop@{loop}}
\index{loop@{loop}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{loop()}{loop()}}
{\footnotesize\ttfamily \label{controller_8cpp_afe461d27b9c48d5921c00d521181f12f} 
...
\Hypertarget{controller_8cpp_ab0787836dbac9ac3282c7a75e2fa610e}\index{controller.cpp@{controller.cpp}!sendEncoder@{sendEncoder}}
\index{sendEncoder@{sendEncoder}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{sendEncoder()}{sendEncoder()}}
{\footnotesize\ttfamily \label{controller_8cpp_ab0787836dbac9ac3282c7a75e2fa610e} 
...
\Hypertarget{controller_8cpp_a4fc01d736fe50cf5b977f755b675f11d}\index{controller.cpp@{controller.cpp}!setup@{setup}}
\index{setup@{setup}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{setup()}{setup()}}
{\footnotesize\ttfamily \label{controller_8cpp_a4fc01d736fe50cf5b977f755b675f11d} 
...
\Hypertarget{controller_8cpp_a9fbbd7dc890701e0443abc1a21ac0006}\index{controller.cpp@{controller.cpp}!encoderLPinA@{encoderLPinA}}
\index{encoderLPinA@{encoderLPinA}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{encoderLPinA}{encoderLPinA}}
{\footnotesize\ttfamily \label{controller_8cpp_a9fbbd7dc890701e0443abc1a21ac0006} 
const int encoder\+LPinA = 3}

\Hypertarget{controller_8cpp_a567fe466db6b232554d452b32157562c}\index{controller.cpp@{controller.cpp}!encoderLPinB@{encoderLPinB}}
\index{encoderLPinB@{encoderLPinB}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{encoderLPinB}{encoderLPinB}}
{\footnotesize\ttfamily \label{controller_8cpp_a567fe466db6b232554d452b32157562c} 
const int encoder\+LPinB = 5}

\Hypertarget{controller_8cpp_a0fed02acc4ae19ecb7c031c63daa7534}\index{controller.cpp@{controller.cpp}!encoderRPinA@{encoderRPinA}}
\index{encoderRPinA@{encoderRPinA}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{encoderRPinA}{encoderRPinA}}
{\footnotesize\ttfamily \label{controller_8cpp_a0fed02acc4ae19ecb7c031c63daa7534} 
const int encoder\+RPinA = 2}

\Hypertarget{controller_8cpp_af0a6d6ca24cf529c231f004d433cd150}\index{controller.cpp@{controller.cpp}!encoderRPinB@{encoderRPinB}}
\index{encoderRPinB@{encoderRPinB}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{encoderRPinB}{encoderRPinB}}
{\footnotesize\ttfamily \label{controller_8cpp_af0a6d6ca24cf529c231f004d433cd150} 
const int encoder\+RPinB = 4}

\Hypertarget{controller_8cpp_a4e06646df6da7b312a077883a53d1e60}\index{controller.cpp@{controller.cpp}!MotorLLEN@{MotorLLEN}}
\index{MotorLLEN@{MotorLLEN}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorLLEN}{MotorLLEN}}
{\footnotesize\ttfamily \label{controller_8cpp_a4e06646df6da7b312a077883a53d1e60} 
const int Motor\+LLEN = 10}

\Hypertarget{controller_8cpp_a1b7a47d17609652e25722b2bde57764c}\index{controller.cpp@{controller.cpp}!MotorLLPWM@{MotorLLPWM}}
\index{MotorLLPWM@{MotorLLPWM}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorLLPWM}{MotorLLPWM}}
{\footnotesize\ttfamily \label{controller_8cpp_a1b7a47d17609652e25722b2bde57764c} 
const int Motor\+LLPWM = 12}

\Hypertarget{controller_8cpp_ae0ffb79f982352ded2ee139f7b048979}\index{controller.cpp@{controller.cpp}!MotorLREN@{MotorLREN}}
\index{MotorLREN@{MotorLREN}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorLREN}{MotorLREN}}
{\footnotesize\ttfamily \label{controller_8cpp_ae0ffb79f982352ded2ee139f7b048979} 
const int Motor\+LREN = 11}

\Hypertarget{controller_8cpp_ab0acde7949aaec1b50231ecd5e7007cc}\index{controller.cpp@{controller.cpp}!MotorLRPWM@{MotorLRPWM}}
\index{MotorLRPWM@{MotorLRPWM}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorLRPWM}{MotorLRPWM}}
{\footnotesize\ttfamily \label{controller_8cpp_ab0acde7949aaec1b50231ecd5e7007cc} 
const int Motor\+LRPWM = 13}

\Hypertarget{controller_8cpp_a1cae64bb9fe4e2c5b2c428375c53efd1}\index{controller.cpp@{controller.cpp}!MotorRLEN@{MotorRLEN}}
\index{MotorRLEN@{MotorRLEN}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorRLEN}{MotorRLEN}}
{\footnotesize\ttfamily \label{controller_8cpp_a1cae64bb9fe4e2c5b2c428375c53efd1} 
const int Motor\+RLEN = 6}

\Hypertarget{controller_8cpp_a09e09e0862b9750ad5f4e9634766ffab}\index{controller.cpp@{controller.cpp}!MotorRLPWM@{MotorRLPWM}}
\index{MotorRLPWM@{MotorRLPWM}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorRLPWM}{MotorRLPWM}}
{\footnotesize\ttfamily \label{controller_8cpp_a09e09e0862b9750ad5f4e9634766ffab} 
const int Motor\+RLPWM = 8}

\Hypertarget{controller_8cpp_ac785618ca1a33df4380be9a615d5f174}\index{controller.cpp@{controller.cpp}!MotorRREN@{MotorRREN}}
\index{MotorRREN@{MotorRREN}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorRREN}{MotorRREN}}
{\footnotesize\ttfamily \label{controller_8cpp_ac785618ca1a33df4380be9a615d5f174} 
const int Motor\+RREN = 7}

\Hypertarget{controller_8cpp_a9146477edd755d01a99fe34e05f90ec8}\index{controller.cpp@{controller.cpp}!MotorRRPWM@{MotorRRPWM}}
\index{MotorRRPWM@{MotorRRPWM}!controller.cpp@{controller.cpp}}
\doxysubsubsection{\texorpdfstring{MotorRRPWM}{MotorRRPWM}}
{\footnotesize\ttfamily \label{controller_8cpp_a9146477edd755d01a99fe34e05f90ec8} 
